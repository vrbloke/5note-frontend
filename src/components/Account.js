      ...
      <div style={{border: "1px solid white", padding: "50px", marginLeft: "20%", marginTop: "8%",height: "200px",borderRadius: "12px",color: "lightgray"}}>
        <div style={{display: "flex"}}>
          ...
          <div style={{display: "block",marginLeft: "100px"}}>
            <h2>Login</h2>
            <input style={{fontSize:'20px', height:'37px', marginLeft:'1px',marginBottom:'10px', width:'150px', textAlign:'center'}} id="nickInput" type="text" defaultValue={"nick"} disabled={true}></input>
            <Button 
            margines={'0 auto'}
            text={"Zmień nick"} 
